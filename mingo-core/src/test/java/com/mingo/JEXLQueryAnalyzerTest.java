...
import com.mingo.query.analyzer.JEXLQueryAnalyzer;
...
/**
 * Test for {@link com.mingo.query.analyzer.JEXLQueryAnalyzer}
 */
public class JEXLQueryAnalyzerTest {

    private JEXLQueryAnalyzer jexlQueryAnalyzer = new JEXLQueryAnalyzer();
    ...
    public void testVerify(String exp, Map<String, Object> parameters, boolean result) {
        assertEquals(result, jexlQueryAnalyzer.evaluate(exp, parameters));
    }
