 ...
 */
package com.jmingo.document.id;
...
import com.jmingo.exceptions.IdGenerationException;
...
import static com.jmingo.util.DocumentUtils.isId;
...
public class IdFieldGenerator {
     ...
     * inherited fields that annotated with {@link com.jmingo.document.annotation.Id} and with {@link com.jmingo.document.annotation.GeneratedValue}.
     * <p>
     * Generation depends on chosen strategy or a given id field type.
     * see predefined id generators strategies {@link com.jmingo.document.id.generator.IdGeneratorStrategy}.
     * <p>
