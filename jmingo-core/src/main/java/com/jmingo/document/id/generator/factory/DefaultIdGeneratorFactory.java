...
import com.jmingo.document.id.generator.ObjectIdGenerator;
import com.jmingo.document.id.generator.SnowflakeGenerator;
import com.jmingo.document.id.generator.UUIDGenerator;
...
public class DefaultIdGeneratorFactory implements IdGeneratorFactory {
     ...
     *                 {@link com.jmingo.document.id.generator.IdGeneratorStrategy#TYPE} then factory
