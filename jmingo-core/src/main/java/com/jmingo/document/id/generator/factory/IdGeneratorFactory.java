 ...
 */
package com.jmingo.document.id.generator.factory;


import com.jmingo.document.id.generator.IdGenerator;
...
public interface IdGeneratorFactory {
     ...
     *
     * @param strategy    the name of strategy, not necessary to be mentioned in {@link com.jmingo.document.id.generator.IdGeneratorStrategy}
     *                    and can have same name but it's prohibited to use 'type' strategy name
     * @param idGenerator implementation of {@link com.jmingo.document.id.generator.IdGenerator} for the specified strategy
     */
     ...
     * @param idGenerator implementation of {@link com.jmingo.document.id.generator.IdGenerator} for the specified type
     */
