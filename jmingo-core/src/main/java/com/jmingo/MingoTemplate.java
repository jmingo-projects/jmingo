...
import com.jmingo.document.id.IdFieldGenerator;
...
import com.jmingo.mapping.marshall.jackson.JacksonBsonMarshallingFactory;
import com.jmingo.mapping.marshall.mongo.MongoBsonMarshallingFactory;
import com.jmingo.mongo.MongoDBFactory;
import com.jmingo.mongo.index.Index;
import com.jmingo.query.Criteria;
...
import static com.jmingo.util.DocumentUtils.assertDocument;
import static com.jmingo.util.DocumentUtils.getCollectionName;
import static com.jmingo.util.DocumentUtils.getIdValue;
...
public class MingoTemplate {
    ...
    /**
     * Drops specified collection by collection name which is taken from {@link com.jmingo.document.annotation.Document#collectionName()}.
     ...
     * as the collection name is the {@link com.jmingo.document.annotation.Document#collectionName()} or simple class name
