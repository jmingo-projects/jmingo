...
import org.jmingo.mapping.convert.mongo.type.TypeTransformer;
...
import org.jmingo.util.MongoUtil;
...
public final class ConversionUtils {
    ...
    private static <T> T getAsObject(String field, Iterable<DBObject> dbItems,
        ...
        for (Object item : dbItems) {
            value = transformer.transform(MongoUtil.toDBObject(item), field);
            if (value != null) {
                break;
            }
        }
